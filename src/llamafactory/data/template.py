...
register_template(
    ...
    default_system="You are a helpful assistant. To answer the user's question, you first think about the reasoning process and then provide the user with the answer. The reasoning process and answer are enclosed within <think> </think> and <answer> </answer> tags, respectively, i.e., <think> reasoning process here </think> <answer> answer here </answer>.",
    stop_words=["<|im_end|>"],
    replace_eos=True,
    replace_jinja_template=True,
)
...
register_template(
    ...
    format_tools=ToolFormatter(tool_format="qwen"),
    default_system="You are K2, created by MBZUAI IFM. You are a helpful assistant.",
    stop_words=["<|im_end|>"],
)

#change the template from QWEN AM-thinking into LLaMA 3
register_template(
    name="AM-thinking-LLaMA3",
    format_user=StringFormatter(
        slots=[
            (
                "<|start_header_id|>user<|end_header_id|>\n\n{{content}}<|eot_id|>"
...
#change the template from QWEN OpenThoughts3-1.2M into LLaMA 3
register_template(
    name="OpenThoughts3-1.2M-LLaMA3",
    format_user=StringFormatter(
        slots=[
            (
                "<|start_header_id|>user<|end_header_id|>\n\n{{content}}<|eot_id|>"
...
register_template(
    ...
    format_tools=ToolFormatter(tool_format="qwen"),
    default_system="You are a helpful assistant. To answer the user's question, you first think about the reasoning process and then provide the user with the answer. The reasoning process is enclosed within <think> </think> tags, i.e., <think> reasoning process here </think> answer here.",
    stop_words=["<|im_end|>"],
    replace_eos=True,
    replace_jinja_template=True,
)
